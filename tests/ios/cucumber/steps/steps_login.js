...
const login = {
	action: require('../../../../src/ios/pages/login/action.js'),
	assert: require('../../../../src/ios/pages/login/assert.js')
};
...
Given(
	/^the WDIO Native app is launched$/,
	async function () {
...
When(
	...
	async function (username) {
		await login.action.fillEmail(username); // Padronizado com Android
	}
);
